  ...
  return (
    <div className='news' id='ziyuan'>
      <div className='container' style={ { marginBottom: 30 } }>
        <div className='skill-wrap' style={ { marginBottom: 30 } }>
        ...
        <Row style={ { marginBottom: '4em' } }>
          ...
          <Col sm={ 3 } className='s4'>
            <FlippingCard
              frontText='場地空間資源'
              backText='劇場、排練室、剪接室、錄音師、攝影棚及各種配套設備'
            />
          </Col>
          <Col sm={ 3 } className='s4'>
            <FlippingCard
          ...
          <Col sm={ 3 } className='s4'>
            <FlippingCard
              frontText='運營諮詢'
              backText='針對初期創業的文化工作室，提供運營指導跟經營策略，對接地方文創園區'
            />
          </Col>

          <Col xs={ 12 } sm={ 3 } className='s4'>
            <FlippingCard
              frontText='專家評估與指導'
