          ...
          <Row>
            <Col sm={ 6 } md={ 4 }>
              <Media className='services-wrap'>
                <Media.Left className='pull-left'>
                  <Image
                    src='https://res.cloudinary.com/cacicloud/image/upload/v1523627457/mainpage/services1.png'
                    responsive
                  />
                </Media.Left>
                <Media.Body>
            ...
            <Col sm={ 6 } md={ 4 }>
              <Media className='services-wrap'>
                <Media.Left className='pull-left'>
                  <Image
                    src='https://res.cloudinary.com/cacicloud/image/upload/v1523627457/mainpage/services2.png'
                    responsive
                  />
                </Media.Left>
                <Media.Body>
            ...
            <Col sm={ 6 } md={ 4 }>
              <Media className='services-wrap'>
                <Media.Left className='pull-left'>
                  <Image
                    src='https://res.cloudinary.com/cacicloud/image/upload/v1523627457/mainpage/services3.png'
                    responsive
                  />
                </Media.Left>
                <Media.Body>
            ...
            <Col sm={ 6 } md={ 6 }>
              <Media className='services-wrap'>
                <Media.Left className='pull-left'>
                  <Image
                    src='https://res.cloudinary.com/cacicloud/image/upload/v1523627457/mainpage/services4.png'
                    responsive
                  />
                </Media.Left>
                <Media.Body>
            ...
            <Col sm={ 6 } md={ 6 }>
              <Media className='services-wrap'>
                <Media.Left className='pull-left'>
                  <Image
                    src='https://res.cloudinary.com/cacicloud/image/upload/v1523627457/mainpage/services5.png'
                    responsive
                  />
                </Media.Left>
                <Media.Body>
