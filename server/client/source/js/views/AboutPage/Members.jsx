  ...
  return (
    <div>
      ...
      <Row>
        ...
        <Col md={6}>
          <Row>
            <Col md={ 6 } sm={ 6 }>
              <MemberCard
                imgSrc='http://res.cloudinary.com/cacicloud/image/upload/v1510127731/members/cheng_icxdc8.jpg'
                name='程沛威'
                position='版權事務部門主管'
            ...
            <Col md={ 6 } sm={ 6 }>
              <MemberCard
                imgSrc='http://res.cloudinary.com/cacicloud/image/upload/v1510127731/members/mamudi_e76gso.jpg'
                name='马沐笛'
                position='版權事務部門主管'
                about='前香港作曲家及作詞家協會(CASH) 總經理，三大唱片公司（環球、索尼及華納音樂）的合資企業公司OneStop AsiaCEO,國際唱片業協會(IFPI)亞洲區業務顧問並成功創辦版權集體管理組織香港音像聯盟(HKRIA)。'
              />
      ...
      <Row>
        <Col md={ 3 } sm={ 6 }>
          <MemberCard
            imgSrc='http://res.cloudinary.com/cacicloud/image/upload/v1510127732/members/zhang_gxcly1.jpg'
            name='張紫伶'
            position='藝術總監'
        ...
        <Col md={ 3 } sm={ 6 }>
          <MemberCard
            imgSrc='http://res.cloudinary.com/cacicloud/image/upload/v1510127731/members/cui_czdpol.jpg'
            name='崔遠曦'
            position='影視總監'
        ...
        <Col md={ 3 } sm={ 6 }>
          <MemberCard
            imgSrc='http://res.cloudinary.com/cacicloud/image/upload/v1510127732/members/zhai_xdhvod.jpg'
            name='翟月'
