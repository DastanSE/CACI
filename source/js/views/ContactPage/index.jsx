...
const Marker = ({ text }) => <div><i className="fa fa-map-marker" style={{width:15,height:30, color:"red"}}>{text}</i></div>;
              ...
              <div className="row" style={{textAlign:"center"}}>
                ...
                <div className=" col-md-4 map-content">
                  <address>
                        ...
                        <p>Phone:(852) 3610 9194
                          <br /> Email: info@caci.hk</p>
                  </address>
