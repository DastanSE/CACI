...
export default class RepertoirePage extends Component {
  render() {
    return (
      <div>
        <div id="jumu-banner">
          <Carousel id="carousel-example-generic"
            prevIcon={
          ...
          >
            {
              [{imgsrc: '../../assets/img/index-top1.jpg'}, {imgsrc: '../../assets/img/index-top1.jpg'}].map((data, index) => {
                return (
