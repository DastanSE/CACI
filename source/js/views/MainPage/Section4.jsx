          ...
          <div className='container'>
            ...
            <div className='row'>
              <div className='col-sm-6 col-md-4'>
                <div className='media services-wrap wow fadeInDown animated'>
                  <div className='pull-left'>
                    <img className='img-responsive' src='../../assets/img/services/services1.png' />
                  </div>
              ...
              <div className='col-sm-6 col-md-4'>
                <div className='media services-wrap wow fadeInDown animated'>
                  <div className='pull-left'>
                    <img className='img-responsive' src='../../assets/img/services/services2.png' />
                  </div>
                  <div className='media-body'>
              ...
              <div className='col-sm-6 col-md-4'>
                <div className='media services-wrap wow fadeInDown animated'>
                  <div className='pull-left'>
                    <img className='img-responsive' src='../../assets/img/services/services3.png' />
                  </div>
                  <div className='media-body'>
              ...
              <div className='col-sm-6 col-md-6'>
                <div className='media services-wrap wow fadeInDown animated'>
                  <div className='pull-left'>
                    <img className='img-responsive' src='../../assets/img/services/services4.png' />
                  </div>
                  <div className='media-body'>
              ...
              <div className='col-sm-6 col-md-6'>
                <div className='media services-wrap wow fadeInDown animated'>
                  <div className='pull-left'>
                    <img className='img-responsive' src='../../assets/img/services/services5.png' />
                  </div>
                  <div className='media-body'>
