          ...
          <div className='container'>
              ...
              <div className='row wow fadeInDown center'>
                ...
                <div className='col-sm-11 sup-border'>
                  <div className='col-sm-2 col-md-offset-1'>
                    <Image
                      responsive
                      src='../../assets/img/partners/support/红韵.jpg'
                      alt='partners'
                    />
                    <h5>紅韻教育集團</h5>
                  </div>
                  ...
                  <div className='col-sm-2 col-md-offset-1'>
                    <Image
                      responsive
                      src='../../assets/img/partners/support/落网.jpg'
                      alt='partners'
                    />
                    <h5>落網獨立音樂網</h5>
                  </div>
            ...
            <section className='col-sm-12 suptxt'>
              ...
              <div className='row wow fadeInDown'>
                <div className='col-sm-11 center sup-border'>
              ...
              <div className='row wow fadeInDown center'>
                <div className='col-sm-11 sup-border'>
                  ...
                  <div className='col-sm-2 col-md-offset-1'>
                    <Image
                      responsive
                      src='../../assets/img/partners/support/中戏.jpg'
                      alt='partners'
                    />
                    <h5>中國戲曲學院</h5>
                  </div>
                  <div className='col-sm-2 col-md-offset-1'>
                    <Image
                      responsive
                      src='../../assets/img/partners/support/中传.jpg'
                      alt='partners'
                    />
                    <h5>中國傳媒大學</h5>
                  </div>
                ...
                <div className='col-sm-11 sup-border'>
                  <div className='col-sm-2 col-md-offset-1'>
                    <Image
                      responsive
                      src='../../assets/img/partners/support/北舞.jpg'
                      alt='partners'
                    />
                    <h5>北京舞蹈學院</h5>
                  </div>
                  ...
                  <div className='col-sm-2 col-md-offset-1'>
                    <Image
                      responsive
                      src='../../assets/img/partners/support/北体.jpg'
                      alt='partners'
                    />
                    <h5>北京體育大學</h5>
                  </div>
