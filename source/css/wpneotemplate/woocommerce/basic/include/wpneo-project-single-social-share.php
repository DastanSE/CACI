...
<span><?php _e('Share: ','wp-crowdfunding'); ?></span>
    <div class="links">
        ...
        <?php if(get_option('wpneo_googleplus_social_share')=='true'): ?>
            <a href="#" data-type="googleplus" data-url="<?php echo $link; ?>" data-description="<?php echo $title; ?>" class="prettySocial fa fa-google-plus"><i class="wpneo-icon wpneo-icon-gplus"></i></a>
        <?php endif; ?>
